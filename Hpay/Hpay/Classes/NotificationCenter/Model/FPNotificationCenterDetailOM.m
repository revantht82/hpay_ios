...
@implementation FPNotificationCenterDetailOM
MJCodingImplementation

- (id)copyWithZone:(NSZone *)zone {
    FPNotificationCenterDetailOM *copy = [[[self class] allocWithZone:zone] init];
    copy.Id = self.Id;
    copy.Code = self.Code;
...
+ (NSArray *)mModelArrayWithData:(NSArray *)data {
    [FPNotificationCenterDetailOM mj_setupReplacedKeyFromPropertyName:^NSDictionary * {
        return [FPNotificationCenterDetailOM mDataReplaceDictionary];
    }];
