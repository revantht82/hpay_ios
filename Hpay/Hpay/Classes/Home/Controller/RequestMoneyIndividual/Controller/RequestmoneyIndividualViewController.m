...
@interface RequestmoneyIndividualViewController () <UITextViewDelegate>
...
@property(nonatomic, assign) NSInteger selCatId;
...
@implementation RequestmoneyIndividualViewController
...
- (IBAction)confirmClick:(id)sender {
    ...
    RequestIndividualConfirmationView *reqConfView = [RequestIndividualConfirmationView getPayView:amountNumber coinString:cryptoCode amountString:amount requestNotes:self.notesTextView.text];
...
- (void)setupData {
    ...
    // Onur removed to this part of avoid no network issue
...
- (void)confirmationViewDismissed {
    ...
    [RequestFundModelHelper createFundRequestWithCryptoId:cryptoId productCategoryId:nil andAmount: amount withNotes:notes completeBlock: ^(NSDictionary *responseModel, NSInteger errorCode, NSString *errorMessage) {
